...
//Last modified: Wed, Aug 26, 2015 03:42:34 PM
//Codeset: 1252
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.444691748898432 -0.70609683204326323 20.629265090619334 ;
	setAttr ".r" -type "double3" 1.4616472681382744 678.19999999984816 1.3332734231317099e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C44793DD-4DFC-12BA-E2B7-81A9F3F4413C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 27.681614920856322;
...
createNode mesh -n "pPyramidShape1" -p "pPyramid1";
	...
	setAttr -s 4 ".pt";
	setAttr ".pt[0]" -type "float3" 0 -1.7741326 0 ;
	setAttr ".pt[4]" -type "float3" 0 -1.7741326 0 ;
	setAttr ".pt[13]" -type "float3" 0 -1.7741326 0 ;
	setAttr ".pt[14]" -type "float3" 0 -1.7741326 0 ;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polyExtrudeFace15.out" "pPyramidShape1.i";
